# Generated by Django 3.1.4 on 2020-12-27 22:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('H', 'HOUSE'), ('J', 'JOB'), ('S', 'SALE'), ('O', 'OTHER')], default='O', max_length=128)),
            ],
        ),
        migrations.CreateModel(
            name='Fav',
        ...
        migrations.AddField(
            model_name='ad',
            name='category',
            field=models.ForeignKey(help_text='Add a Category', null=True, on_delete=django.db.models.deletion.SET_NULL, to='Ads.category'),
        ),
        migrations.AddField(
            model_name='ad',
            name='comments',
